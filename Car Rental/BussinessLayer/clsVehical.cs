...
namespace BussinessLayer
{
    public class clsVehicle
    {
        ...
        {
            this.VehicleID = clsVehicalDataAccess.AddNewVehicle(this.MakeID, this.ModelID, this.SubModelID,
        ...
        {
            return clsVehicalDataAccess.UpdateVehicle(this.VehicleID, this.MakeID, this.ModelID,
        ...
        {
            return clsVehicalDataAccess.UpdateMileage(this.VehicleID, NewMileage);
        }

        public bool SetAvailableForRent()
        {
            return clsVehicalDataAccess.SetVehicalAvailableForRent(this.VehicleID, true);
        }
        public static clsVehicle Find(int? VehicleID)
        {
            ...
            bool IsFound = clsVehicalDataAccess.GetVehicleInfoByID(VehicleID, ref MakeID, ref ModelID,
        ...
        {
            return clsVehicalDataAccess.GetAllVehiclesInPages(PageNumber, RowsPerPage);
        }

        public static bool DeleteVehicle(int? VehicleID)
        {
            return clsVehicalDataAccess.DeleteVehicle(VehicleID);
        }

       
        public static bool DoesPlateNumberExist(string PlateNumber)
        {
            return clsVehicalDataAccess.FindPlateNumber(PlateNumber);
        }

        public static DataTable GetAllVehicles()
        {
            return clsVehicalDataAccess.GetAllVehicles();
        }
        public static bool DoesVehicleExist(int? VehicleID)
        {
            return clsVehicalDataAccess.DoesVehicleExist(VehicleID);
        }

        public static int GetAvailableVehiclesCount()
        {
            return clsVehicalDataAccess.GetAvailableVehiclesCount();
        }

        public static int GetAllVehiclesCount()
        {
            return clsVehicalDataAccess.GetAllVehiclesCount();
        }
        ...
        {
            return clsVehicalDataAccess.SetVehicalAvailableForRent(this.VehicleID, false);
        }
