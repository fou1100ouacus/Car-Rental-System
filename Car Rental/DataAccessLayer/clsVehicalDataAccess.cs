...
{
    public class clsVehicalDataAccess
    {    // Method to retrieve vehicle information by its ID.
     ...
     (MakeID, ModelID, SubModelID, BodyID, VehicleName, PlateNumber, Year, DriveTypeID, Engine, FuelTypeID, NumberDoors, Mileage, RentalPricePerDay, IsAvailableForRent) values
     (@MakeID, @ModelID, @SubModelID, @BodyID, @VehicleName, @PlateNumber, @Year, @DriveTypeID, @Engine, @FuelTypeID, @NumberDoors, @Mileage, @RentalPricePerDay, @IsAvailableForRent)
        ...
        // Method to update an existing vehicle's information.
...
where VehicleID = @VehicleID";
            ...
            public static int GetAllVehiclesCount()
        {
            ...
            public static bool FindPlateNumber(string PlateNumber)
            {
                bool IsFound = false;
            ...
            public static bool SetVehicalAvailableForRent(int? VehicleID, bool IsAvailable)
            {
                int AffectedRows = 0;
